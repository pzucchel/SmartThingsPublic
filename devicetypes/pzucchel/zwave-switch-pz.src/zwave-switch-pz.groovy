 ...
 */
metadata {
	definition (name: "Z-Wave Switch PZ", namespace: "pzucchel", author: "pzucchel", ocfDeviceType: "oic.d.switch") {
		capability "Actuator"
...
def parse(String description) {
	...
	if (result?.name == 'hail' && hubFirmwareLessThan("000.011.00602")) {
		...
		log.debug "outlet Parse returned ${result?.descriptionText}"
        log.debug "outlet Parse description ${description}"
	}
	return result
}
